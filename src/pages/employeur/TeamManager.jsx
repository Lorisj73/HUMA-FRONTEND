            ...
            <div className="card" style={{ padding: 24, border: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', gap: 12 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: 32, fontWeight: 600, color: 'var(--text)', margin: '4px 0' }}>4</p>
            ...
            <div className="card" style={{ padding: 24, border: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', gap: 12 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: 32, fontWeight: 600, color: 'var(--text)', margin: '4px 0' }}>5</p>
          ...
          <div style={{
            ...
            <div className="card" style={{ padding: isMobile ? 24 : 32, border: '1px solid var(--border)' }}>
              ...
              <div style={{ marginTop: 24 }}>
                {[
                  { name: 'Bonne ambiance et relations d\'équipe', value: 35, color: '#10b981' },
                  { name: 'Solidarité entre collègues', value: 25, color: '#059669' },
                  { name: 'Impact positif immédiat des feedbacks', value: 20, color: '#34d399' },
                  { name: 'Capacité de l\'équipe à encaisser la charge', value: 20, color: '#6ee7b7' }
                ].map((item, i) => (
                  <div key={i} style={{ marginBottom: 16 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            ...
            <div className="card" style={{ padding: isMobile ? 24 : 32, border: '1px solid var(--border)' }}>
              ...
              <div style={{ marginTop: 24 }}>
                {[
                  { name: 'Insatisfaction globale', impact: 'Charge excessive / mal priorisée', value: 30, color: '#f59e0b' },
                  { name: 'Déséquilibre vie pro/perso', impact: 'Manque de reconnaissance', value: 25, color: '#f97316' },
                  { name: 'Manque de clarté et de sens', impact: 'Fatigue mentale accumulée', value: 15, color: '#fb923c' },
                  { name: 'Manque de reconnaissance', impact: 'Poids sur le moral', value: 20, color: '#fdba74' },
                  { name: 'Fatigue mentale', impact: 'Épuisement progressif', value: 10, color: '#fed7aa' }
                ].map((item, i) => (
                  <div key={i} style={{ marginBottom: 16 }}>
                    ...
                    <p style={{ fontSize: 11, color: 'var(--muted)', margin: '0 0 8px 0' }}>{item.impact}</p>
                    <div style={{
                      width: '100%',
                      height: 8,
                      background: '#fef3c7',
            ...
            <div style={{
              ...
              {[
                ...
                },
                {
                  ...
                  priority: 'Moyenne',
                  priorityColor: '#dbeafe',
                  priorityBorder: '#93c5fd',
                  priorityText: '#1e3a8a',
                  efficacy: '+20%',
                  items: [
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 16 }}>
                    <span style={{
                      ...
                      fontSize: 12,
                      fontWeight: 500,
                      background: action.priorityColor,
                      border: `1px solid ${action.priorityBorder}`,
                      color: action.priorityText
                    }}>
                      {action.priority}
                    </span>
                    <span style={{
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 12 }}>
                    <span style={{
                      ...
                      fontSize: 14,
                      fontWeight: 600,
                      background: activity.efficacy >= 15 ? '#d1fae5' : '#dbeafe',
                      border: activity.efficacy >= 15 ? '1px solid #6ee7b7' : '1px solid #93c5fd',
                      color: activity.efficacy >= 15 ? '#065f46' : '#1e3a8a'
                    }}>
                      +{activity.efficacy}%
                    </span>
                  </div>
                  ...
                  <div style={{ 
                    ...
                    <p style={{ fontSize: 12, color: 'var(--muted)', margin: 0 }}>
                      <span style={{ fontWeight: 500 }}>Impact :</span> {activity.impact}
                    </p>
                  </div>
                </div>
              ))}
      ...
      {isGenerating && (
        ...
        >
          ...
          >
            ...
            >
              Huma est en train d'analyser et de générer ton rapport personnalisé
            </p>
            <div
              style={{
                display: 'flex',
