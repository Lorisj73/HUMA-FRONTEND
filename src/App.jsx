      ...
      {showOnboarding ? (
        ...
        <>
          ...
          <div>
            ...
            {page === 'Feedbacks' && <FeedbacksEmployee onNavigate={setPage} onCategorySelect={setSelectedCategory} />}
            {page === 'CategoryDetail' && <CategoryDetail category={selectedCategory} onNavigate={setPage} />}
            {page !== 'Checkin' && page !== 'CheckinStep2' && page !== 'CheckinStep3' && page !== 'Accueil' && page !== 'HomeUnlocked' && page !== 'Moi' && page !== 'Nous' && page !== 'Mon équipe' && page !== 'Feedbacks' && page !== 'CategoryDetail' && (
